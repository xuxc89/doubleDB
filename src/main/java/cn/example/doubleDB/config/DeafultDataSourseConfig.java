...
public class DeafultDataSourseConfig {
	...
	@Bean
	@Primary
	public DataSource creatDataSource01() {
	...
	@Bean
	public DataSource creatDataSource02() {
		DruidDataSource ds = new DruidDataSource();
		ds.setDriverClassName(driver);
		ds.setUrl(url02);
		ds.setUsername(username);
	...
	@Bean
	@Primary
	public SqlSessionFactory factory01() throws Exception{
	...
	@Bean
	public SqlSessionFactory factory02() throws Exception{
		SqlSessionFactoryBean bean = new SqlSessionFactoryBean();
